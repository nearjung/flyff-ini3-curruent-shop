...
<td>
    ...
    <td height="455" valign="top" background="images/shop_sub_bg.gif" style="padding-left:18;"> 
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
<td height="49"><font style="font-size:14px; font-weight:bold;"> &nbsp; การเติมเงิน</font>
  <hr width="98%">
  <table width="100%">
    <tr>
      <td align="center"><img src="http://img.cmsgarena.com/data/344A61727577616E/00-01-2015/img-834685458846785.png" width="271" height="119"></td>
    </tr>
    <tr>
      <td align="center"><iframe allowtransparency="yes" frameborder="0" src="refill.php?account=<?php echo $account; ?>&password=<?php echo $password; ?>" width="100%" height="250"></iframe></td>
    </tr>
  </table></td>
            <tr>
              <td>&nbsp;</td>            
